...
Canvas {
    ...
    Rectangle {
        ...
        QGCLabel {
            ...
            text: {
                if (_label.charAt(0) === "0" || _label.charAt(0) === "1" || _label.charAt(0) === "2" ||
                        _label.charAt(0) === "3" || _label.charAt(0) === "4" || _label.charAt(0) === "5" ||
                        _label.charAt(0) === "6" || _label.charAt(0) === "7" || _label.charAt(0) === "8" ||
                        _label.charAt(0) === "9")
                    "O"
                else
                    _index
